...
# Examples:
#
#   # Wordpress::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Wordpress::Base
...
#   s.save!
module Wordpress::Preferences::Preferable
    extend ActiveSupport::Concern
  
    included do
      extend Wordpress::Preferences::PreferableClassMethods
    end
