module Wordpress
    class ServerController < Wordpress::BaseController  
        ...
        def install_os7_mysqlv8
            render "wordpress/server/install_os7_mysqlv8", layout: false, content_type: 'text/plain'
        end

        def install_os8_mysqlv8
            render "wordpress/server/install_os8_mysqlv8", layout: false, content_type: 'text/plain'
        end
